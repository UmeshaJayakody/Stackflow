          ...
          <div className="relative bg-white/40 backdrop-blur-md border border-gray-200/50 rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300">
            ...
            <div className="relative p-6">
              ...
              <div className="mt-4 pt-4 border-t border-gray-200/50">
                <Link
                  href="/warehouses"
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-gray-900 to-black text-white rounded-xl hover:from-black hover:to-gray-900 font-bold shadow-lg transition-all duration-300 hover:scale-105"
                >

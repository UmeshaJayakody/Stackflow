        ...
        <div className="p-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">
              You are about to delete <span className="font-semibold text-gray-900">&quot;{user.fullName}&quot;</span>.
            </p>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-red-800">
                <strong>Warning:</strong> This action cannot be undone. The user will lose access to the system and all associated data.
              </p>
            </div>
          </div>

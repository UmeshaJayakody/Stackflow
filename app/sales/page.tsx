  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-6 md:px-8 lg:px-12 py-8">
        {/* Stats */}
        <div className="bg-gradient-to-br from-orange-50/60 to-red-50/40 backdrop-blur-md rounded-2xl shadow-2xl hover:shadow-3xl border border-orange-200/50 p-6 mb-8 transition-shadow duration-300">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
            <h3 className="text-lg font-semibold text-orange-900">Sales Dashboard</h3>
            <button
          ...
          <div className="group relative bg-gradient-to-br from-orange-50/80 to-red-50/60 backdrop-blur-lg rounded-2xl shadow-2xl hover:shadow-3xl border border-orange-200/50 p-6 transform hover:scale-105 transition-all duration-300 overflow-hidden">
            ...
            <div className="relative flex items-center justify-between">
              <div>
                <h3 className="text-sm font-bold text-orange-700 uppercase tracking-wide">Total Sales</h3>
          ...
          <div className="group relative bg-gradient-to-br from-red-50/80 to-orange-50/60 backdrop-blur-lg rounded-2xl shadow-2xl hover:shadow-3xl border border-red-200/50 p-6 transform hover:scale-105 transition-all duration-300 overflow-hidden">
            ...
            <div className="relative flex items-center justify-between">
              <div>
                <h3 className="text-sm font-bold text-red-700 uppercase tracking-wide">Items Sold</h3>
          ...
          <div className="group relative bg-gradient-to-br from-orange-50/80 to-red-50/60 backdrop-blur-lg rounded-2xl shadow-2xl hover:shadow-3xl border border-orange-200/50 p-6 transform hover:scale-105 transition-all duration-300 overflow-hidden">
            ...
            <div className="relative flex items-center justify-between">
              <div>
                <h3 className="text-sm font-bold text-orange-700 uppercase tracking-wide">Total Revenue</h3>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white/80 divide-y divide-gray-200">
                  {sales.map((sale, index) => (
                    <tr key={sale.saleId} className={`${index % 2 === 0 ? 'bg-orange-50/30' : 'bg-red-50/30'} hover:bg-orange-100/50 transition-all duration-200`}>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">
                        {new Date(sale.saleDate).toLocaleDateString()}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-bold text-gray-900">{sale.product.productName}</div>
                        <div className="text-sm font-semibold text-orange-600">{sale.product.sku}</div>
                      </td>
